...
The Stoplight Prism nomad pack provides a simple way to run the Stoplight Prism Docker image on Nomad. In depth information about the docker image and the components can be found at the (Prism page on Stoplight.io)[https://stoplight.io/open-source/prism].
